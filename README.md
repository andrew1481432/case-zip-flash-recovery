...
<p align="center">
  <a href="#восстановление-утилитой-photorec">Восстановление утилитой PhotoRec</a><br>
  <a href="#поиск-архива-в-образе-диска-по-сигнатурам">Поиск архива в образе диска по сигнатурам</a><br>
  <a href="#что-осталось-на-exfat-после-rm--rf">Что осталось на exFAT после rm -rf</a><br>
  <a href="#самописный-сканер-zip_carver">Самописный сканер zip_carver</a><br>
  &nbsp;&nbsp;&nbsp;&nbsp;<a href="#проход-1-есть-ли-следы">Проход 1: «есть ли следы»</a><br>
  &nbsp;&nbsp;&nbsp;&nbsp;<a href="#проход-2-список-кандидатов">Проход 2: список кандидатов</a><br>
  &nbsp;&nbsp;&nbsp;&nbsp;<a href="#второй-needle-и-разбор-каталога">Второй needle и разбор каталога</a><br>
  <a href="#вытаскивание-файлов">Вытаскивание файлов</a>
</p>
...
Процесс занял около 7–8 часов. На середине флешка отвалилась по USB, скан пришлось запустить заново. В итоге получил много файлов, но без нормальной структуры: обрывки, `recup_dir/...`, куча битых ZIP. Нужного архива ~28 ГБ среди них не было.
